<template>
  <div class="write-weekly">
    ...
    <!-- 本周重点工作总结 -->
<div class="container thisweek">
  <div class="title-Bg bg-thisweek">本周重点工作总结</div>
  <table cellspacing="5" cellpadding="0" class="table">
    <tbody>
      ...
      <tr>
        <td>1</td>
        <td>
          <input class="basic-form" data-action="editText" value="请输入您的工作内容"/>
        </td>
        <td>
          <input class="basic-form" data-action="editText"/>
        </td>
        <td>
          <input class="basic-form" data-action="editText"/>
        </td>
        ...
        <td class="operate">
          <a href="javascript:" class="add-okr" title="增加">+</a>
          <a href="javascript:" class="del-okr" title="删除">-</a>
        </td>
      </tr>
      <tr>
        <td>2</td>
      ...
      <!-- <tr>
        <td></td>
        <td>
          <input class="form-control" type="text" value="" placeholder="请输入内容">
        </td>
        <td>
          <input class="form-control" type="text" value="" placeholder="请输入内容">
        </td>
        ...
        <td class="operate">
          <button type="button" class="submit">完成</button>
        </td>
      </tr> -->
    </tbody>
  </table>
...
<!-- 下周重点工作计划 -->
<div class="container nextweek">
  <div class="title-Bg bg-nextweek">下周重点工作计划</div>
  <table cellspacing="5" cellpadding="0" class="table">
    <tbody>
      <!-- 标题名称 -->
      <tr>
...
$(function () {
  $('.add-okr').click(function () {
    var self = $(this)
    var sibl = self.parents('.table tr')
    // 在table 中生成tr
    var okrhtml = $('<tr><td></td><td><input class="form-control" name="input1" type="text" placeholder="请输入内容"></td><td><input class="form-control" name="input2" type="text" placeholder="请输入内容"></td><td><input class="form-control" name="input3" type="text" placeholder="请输入内容"></td><td><input class="form-control" name="input4" type="text" placeholder="请输入内容"></td><td class="operate"><button type="button" class="submit">完成</button></td></tr>')
    sibl.after(okrhtml)
  })
  // 获取form的值
  // var input1 = $("<input class=\"form-control\" name=\"input1\" type=\"text\" placeholder=\"请输入内容\">").val();
  // var input2 = $("<input class=\"form-control\" name=\"input2\" type=\"text\" placeholder=\"请输入内容\">").val();
  // var input3 = $("<input class=\"form-control\" name=\"input3\" type=\"text\" placeholder=\"请输入内容\">").val();
  // var input4 = $("<input class=\"form-control\" name=\"input4\" type=\"text\" placeholder=\"请输入内容\">").val();
  $('.del-okr').click(function () {
    var self = $(this)
    var sibl = self.parents('.table tr')
    sibl.remove()
  })
